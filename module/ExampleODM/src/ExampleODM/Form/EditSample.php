...
use Application\Validator\DocumentNotExists;
...
class EditSample extends Form
{
    ...
    /**
     * ID of the document being edited (null when creating)
     *
     * @var integer
     */
    protected $id = null;
     ...
     * Constructor
     *
     * @param DocumentManager  $em          Doctrine DocumentManager
     * @param integer          $id          ID of the document being edited (null when creating)
     * @param null|int|string  $name        Optional name
     * @param array            $options     Optional options
     */
    public function __construct($dm, $id = null, $name = 'edit-sample', $options = array())
    {
        $this->dm = $dm;
        $this->id = $id;
    ...
    public function getInputFilter()
    {
        ...
        $params = [
            ...
            'document'        => 'Application\Document\Sample',
        ...
        $string->getValidatorChain()
               ->attach(new DocumentNotExists($params));
        $filter->add($string);
